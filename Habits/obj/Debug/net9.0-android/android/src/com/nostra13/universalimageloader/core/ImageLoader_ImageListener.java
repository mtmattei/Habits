...
public class ImageLoader_ImageListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Nostra13.Universalimageloader.Core.ImageLoader+ImageListener, UniversalImageLoader", ImageLoader_ImageListener.class, __md_methods);
	}

	public ImageLoader_ImageListener ()
	{
		super ();
		if (getClass () == ImageLoader_ImageListener.class) {
			mono.android.TypeManager.Activate ("Com.Nostra13.Universalimageloader.Core.ImageLoader+ImageListener, UniversalImageLoader", "", this, new java.lang.Object[] {  });
		}
	}
