...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_detachViewsFromParent:(II)V:GetDetachViewsFromParent_IIHandler\n" +
			"n_detachViewFromParent:(Landroid/view/View;)V:GetDetachViewFromParent_Landroid_view_View_Handler\n" +
	...
	public void detachViewsFromParent (int p0, int p1)
	{
		n_detachViewsFromParent (p0, p1);
	}

	private native void n_detachViewsFromParent (int p0, int p1);

	public void detachViewFromParent (android.view.View p0)
	{
		n_detachViewFromParent (p0);
	}

	private native void n_detachViewFromParent (android.view.View p0);
